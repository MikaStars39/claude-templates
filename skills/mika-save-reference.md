---
name: mika-save-reference
description: "Save an external resource (paper, blog, repo, API doc) into docs/reference/<slug>.md as TL;DR + key takeaways + when-to-apply. Prevents CC from re-fetching the same content. Use after reading something useful or when user says \"存进 reference\" / \"记一下这个 paper\"."
user_invocable: true
---
