---
name: mika-create-arch
description: "Draft an arch document (docs/arch/<module>.md) for a specified module. Reads source + nearby READMEs and captures design intent, tradeoffs, cross-module constraints. Refuses to do line-by-line code description (the anti-pattern). Use after adding a new module or to backfill arch docs for existing modules."
user_invocable: true
---
